...
masif_app = sys.argv[2] ## 26. Jan

if masif_app == 'fp_score':
    params = masif_opts['fingerprint_score']

# Save the chains as separate files. ## 26. Jan: eg. tcr_000001_DE
in_fields = sys.argv[1].split("_")
tcr_mark = in_fields[0] # "tcr"
t_index = in_fields[1]  # Index, 25.Dec
pdb_id = tcr_mark + "_" + t_index  ## dir prefix, 25 Dec
chain_ids1 = in_fields[2]  # TCR two chains(eg. DE), 25.Nov:)
...
print(f"已保存 TCR surface vertices 的坐标分量到: {save_dir}")
