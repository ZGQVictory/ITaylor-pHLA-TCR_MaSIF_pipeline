            ...
            with tf.device(idx_gpu):
                ...
                for i in range(self.n_feat):
                    ...
                    W_conv = tf.get_variable(
                        ...
                        initializer=tf.keras.initializers.glorot_normal(), ## SC, the UP row is replaced by this row #0527
                        ## NOTE: https://blog.csdn.net/weixin_44069398/article/details/109490910
                    )
                ...
                ## SC, the UP row is replaced by the DOWN row and pay attention to the name of "activation" 
                ## NOTE: https://blog.csdn.net/weixin_45540964/article/details/126150249
                self.global_desc = tf.layers.dense(
                    self.global_desc,
                    self.n_thetas * self.n_rhos,
